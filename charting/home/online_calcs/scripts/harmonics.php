...
require_once($_SERVER['DOCUMENT_ROOT'] . "/charting/home/online_calcs/scripts/constants_eng.php");
...
if (isset($_POST['submitted']) || isset($_POST['h_sys_submitted'])) {
    ...
    $h_sys = mysqlSafeEscapeString($conn, isset($_POST["h_sys"]) ? $_POST["h_sys"] : "p");
    ...
    if ($harmonic_val < 1 Or $harmonic_val > 31) {
        $harmonic_val = 9;
    }    //the default is 9

    if ($harmonic_age < 0 Or $harmonic_age > 1) {
        $harmonic_age = 0;
    ...
    if ($harmonic_age == 1) {
        ...
        if ($start_month != "" And $start_day != "" And $start_year != "") {
            if (!$date = checkdate($start_month, $start_day, $start_year)) {
                $my_error .= "<br><br>The harmonic age date you entered is not valid.<br>";
            }
        }

        if (($start_year < 1200) Or ( $start_year >= 2400)) {
            $my_error .= "<br><br>Harmonic age date - please enter a year between 1200 and 2399.<br>";
        }

        //if (( isset($my_error) ?: "" ) == "") {
        if ($my_error == "") {
            $jd_now = 0; //gregoriantojd($start_month, $start_day, $start_year);
            $jd_bd = 0; //gregoriantojd($month1, $day1, $year1);
...
//harmonic calculations
        ...
        for ($i = 1; $i <= 12; $i++) {
            $hc1[$i] = Crunch($longitude1[LAST_PLANET + 1] + (($i - 1) * 30));
        }
...
//display natal data
        ...
        $timezone2 = (isset($timezone2) ? $timezone2 : 0);
        ...
        $the_dt = ConvertJDtoDateandTime((isset($Result_JD) ? $Result_JD : 0), $timezone2);
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            $_POST['id1']           = isset($_POST['id1'])          ? $_POST['id1'] : $id1;
            $_POST['name1']         = isset($_POST['name1'])        ? $_POST['name1'] : $name1;
            $_POST['month1']        = isset($_POST['month1'])       ? $_POST['month1'] : $month1;
            $_POST['day1']          = isset($_POST['day1'])         ? $_POST['day1'] : $day1;
            $_POST['year1']         = isset($_POST['year1'])        ? $_POST['year1'] : $year1;
            $_POST['hour1']         = isset($_POST['hour1'])        ? $_POST['hour1'] : $hour1;
            $_POST['minute1']       = isset($_POST['minute1'])      ? $_POST['minute1'] : $minute1;
            $_POST['timezone1']     = isset($_POST['timezone1'])    ? $_POST['timezone1'] : $timezone1;
            $_POST['long_deg1']     = isset($_POST['long_deg1'])    ? $_POST['long_deg1'] : $long_deg1;
            $_POST['long_min1']     = isset($_POST['long_min1'])    ? $_POST['long_min1'] : $long_min1;
            $_POST['ew1']           = isset($_POST['ew1'])          ? $_POST['ew1'] : $ew1;
            $_POST['lat_deg1']      = isset($_POST['lat_deg1'])     ? $_POST['lat_deg1'] : $lat_deg1;
            $_POST['lat_min1']      = isset($_POST['lat_min1'])     ? $_POST['lat_min1'] : $lat_min1;
            $_POST['ns1']           = isset($_POST['ns1'])          ? $_POST['ns1'] : $ns1;
            $_POST['start_month']   = isset($_POST['start_month'])  ? $_POST['start_month'] : $start_month;
            $_POST['start_day']     = isset($_POST['start_day'])    ? $_POST['start_day'] : $start_day;
            $_POST['start_year']    = isset($_POST['start_year'])   ? $_POST['start_year'] : $start_year;

            $_POST['long_deg2']     = isset($_POST['long_deg2'])    ? $_POST['long_deg2'] : $long_deg1;
            $_POST['long_min2']     = isset($_POST['long_min2'])    ? $_POST['long_min2'] : $long_min1;
            $_POST['ew2']           = isset($_POST['ew2'])          ? $_POST['ew2'] : $ew1;
            $_POST['ns2']           = isset($_POST['ns2'])          ? $_POST['ns2'] : $ns1;
            $_POST['lat_deg2']      = isset($_POST['lat_deg2'])     ? $_POST['lat_deg2'] : $lat_deg1;
            $_POST['lat_min2']      = isset($_POST['lat_min2'])     ? $_POST['lat_min2'] : $lat_min1;
            $_POST['timezone2']     = isset($_POST['timezone2'])    ? $_POST['timezone2'] : $timezone1;
            ?>
        ...
        $hour2 = (isset($hour2) ? $hour2 : 0);
        $minute2 = (isset($minute2) ? $minute2 : 0);
        $speed2 = (isset($speed2) ? $speed2 : 0);
        //JWX
...
//            $dd[$j] = (isset($hc1[$j]) ? $hc1[$j] : 0);
//        }
//        $hc1 = $dd;
//
//        $dd = array_fill(0, $lpn, 0);
//        for ($j = 0; $j < $last_planet_num; $j++) {
//            $dd[$j] = (isset($hc2[$j]) ? $hc2[$j] : 0);
//        }
//        $hc2 = $dd;
//
//        $dd = array_fill(0, $lpn, 0);
//        for ($j = 0; $j < $last_planet_num; $j++) {
//            $dd[$j] = (isset($longitude1[$last_planet_num + $i]) ? $longitude1[$last_planet_num + $i] : 0);
//        }
//        $longitude1 = $dd;
//
//        $dd = array_fill(0, $lpn, 0);
//        for ($j = 0; $j < $last_planet_num; $j++) {
//            $dd[$j] = (isset($longitude2[$last_planet_num + $i]) ? $longitude2[$last_planet_num + $i] : 0);
//        }
//        $longitude2 = $dd;
...
////        var_dump($longitude1);  
////        var_dump($longitude2);  
////        print $last_planet_num + $i;
//            if ($last_planet_num * 2 < $lpn) {
...
//        }
        ...
        echo "<center>";
        echo "<img border='0' src='natal_wheel_HA.php?session_name=$sessionName&rx1=$rx1&l1=$line1' width='$wheel_width' height='$wheel_height'>";
        echo "<br /><br />";

        echo "<img border='0' src='aspect_grid_sr_HA.php?session_name=$sessionName&rx1=$rx1&p0=$L1[0]&p1=$L1[1]&p2=$L1[2]&p3=$L1[3]&p4=$L1[4]&p5=$L1[5]&p6=$L1[6]&p7=$L1[7]&p8=$L1[8]&p9=$L1[9]&p10=$L1[10]&p11=$L1[11]&p12=$L1[12]&p13=$L1[13]&p14=$L1[14]&c1=$hc1[1]&c10=$hc1[10]' width='705' height='450'>";
        echo "<br /><br />";

        echo "<img border='0' src='harmonic_wheel.php?session_name=$sessionName&rx1=$rx2&l1=$line2' width='$wheel_width' height='$wheel_height'>";
        echo "<br /><br />";

        echo "<img border='0' src='aspect_grid_harmonic.php?session_name=$sessionName&rx1=$rx2&p0=$L2[0]&p1=$L2[1]&p2=$L2[2]&p3=$L2[3]&p4=$L2[4]&p5=$L2[5]&p6=$L2[6]&p7=$L2[7]&p8=$L2[8]&p9=$L2[9]&p10=$L2[10]&p11=$L2[11]&p12=$L2[12]&p13=$L2[13]&p14=$L2[14]&c1=$hc2[1]&c10=$longitude2_MC' width='705' height='450'>";
        echo "<br /><br />";
