...
//end of modified code
        ...
        // this is here because we must rename the planet names
...
// no need to urlencode unless perhaps magic quotes is ON (??)
        ...
        echo "<center>";
        echo "<img border='0' src='natal_wheel_VO.php?session_name=vocation&rx1=$rx1&l1=$line1' width='$wheel_width' height='$wheel_height'>";
        echo "<br><br>";
        echo "<img border='0' src='natal_aspect_grid_VO.php?session_name=vocation&rx1=$rx1&rx2=$rx2&ubt1=$ubt1&ubt2=$ubt2' width='705' height='450'>";
        echo "</center>";
        echo "<br>";
