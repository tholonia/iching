...
require_once($_SERVER['DOCUMENT_ROOT'] . "/charting/home/online_calcs/constants.php");
...
$line1 = mysqlSafeEscapeString($conn, (isset($_GET["l1"]) ? $_GET["l1"] : null));

$ubt1 = intval(mysqlSafeEscapeString($conn, (isset($_GET["ubt1"]) ? $_GET["ubt1"] : null)));

$retrograde = mysqlSafeEscapeString($conn, (isset($_GET["rx1"]) ? $_GET["rx1"] : null));

$longitude = $_SESSION['longitude1_HA'];
$hc = $_SESSION['hc1_HA'];
$house_pos = $_SESSION['house_pos1_HA'];http://slider.com/charting/home/online_calcs/scripts/natal_wheel_HA.php?session_name=harmonics&rx1=%20%20%20R%20%20R%20R%20R%20%20&l1=Jeff_Milton,%20born%20on%20Sunday,%20June%2017,%201956%20at%2002:17%20(time%20zone%20=%20GMT%20-4%20hours)%20at%2074w36%20and%2040n34

      saveSession("natal_wheel_HA");
...
for ($i = 0; $i <= 330; $i = $i + 30) {
    ...
    $flag = ((isset($flag) ? $flag : FALSE));//JWX
