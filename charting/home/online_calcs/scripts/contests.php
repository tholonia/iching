...
//        $house_pos1[$key] = (isset($row[2]) ? $row[2] : null);
        ...
        if ($lng1[SE_TSNODE] >= 360) {
            $lng1[SE_TSNODE] = $lng1[SE_TSNODE] - 360;
        }
...
//calculate how high our table must be
        ...
        echo "<img border='0' src='contest_wheel.php?session_name=$sessionName&rx1=$rx1&l1=$line1&l2=$line2&l3=$line3&l4=$line4&eh=$extra_height_for_graphic_data_table&ew=$extra_width_for_graphic_data_table&ytm=$y_top_margin'>";
        echo "<br>";
        echo "<img border='0' src='contest_wheel_-_small_longitude.php?session_name=$sessionName&rx1=$rx1'>";
        echo "<img border='0' src='contest_wheel_-_small_antiscia.php?session_name=$sessionName&rx1=$rx1'>";
        ...
        for ($i = SE_SUN; $i <= SE_SATURN; $i++) {
            ...
            if ($i == SE_JUPITER And $lng1[$i] >= 0 And $lng1[$i] < 6) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 6 And $lng1[$i] < 14) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 14 And $lng1[$i] < 21) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 21 And $lng1[$i] < 26) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 26 And $lng1[$i] < 30) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 30 And $lng1[$i] < 38) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 38 And $lng1[$i] < 45) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 45 And $lng1[$i] < 52) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 52 And $lng1[$i] < 56) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 56 And $lng1[$i] < 60) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 60 And $lng1[$i] < 67) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 67 And $lng1[$i] < 74) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 74 And $lng1[$i] < 81) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 81 And $lng1[$i] < 85) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 85 And $lng1[$i] < 90) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 90 And $lng1[$i] < 96) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 96 And $lng1[$i] < 103) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 103 And $lng1[$i] < 110) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 110 And $lng1[$i] < 117) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 117 And $lng1[$i] < 120) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 120 And $lng1[$i] < 126) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 126 And $lng1[$i] < 133) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 133 And $lng1[$i] < 139) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 139 And $lng1[$i] < 145) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 145 And $lng1[$i] < 150) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 150 And $lng1[$i] < 157) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 157 And $lng1[$i] < 163) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 163 And $lng1[$i] < 168) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 168 And $lng1[$i] < 174) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 174 And $lng1[$i] < 180) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 180 And $lng1[$i] < 186) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 186 And $lng1[$i] < 191) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 191 And $lng1[$i] < 199) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 199 And $lng1[$i] < 204) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 204 And $lng1[$i] < 210) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 210 And $lng1[$i] < 216) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 216 And $lng1[$i] < 224) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 224 And $lng1[$i] < 231) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 231 And $lng1[$i] < 237) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 237 And $lng1[$i] < 240) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 240 And $lng1[$i] < 248) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 248 And $lng1[$i] < 254) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 254 And $lng1[$i] < 259) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 259 And $lng1[$i] < 265) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 265 And $lng1[$i] < 270) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 270 And $lng1[$i] < 276) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 276 And $lng1[$i] < 282) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 282 And $lng1[$i] < 289) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 289 And $lng1[$i] < 295) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 295 And $lng1[$i] < 300) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 300 And $lng1[$i] < 306) {
                $dignity_debility[SE_SATURN] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 306 And $lng1[$i] < 312) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 312 And $lng1[$i] < 320) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 320 And $lng1[$i] < 325) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 325 And $lng1[$i] < 330) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_VENUS And $lng1[$i] >= 330 And $lng1[$i] < 338) {
                $dignity_debility[SE_VENUS] = 2;
            }
            if ($i == SE_JUPITER And $lng1[$i] >= 338 And $lng1[$i] < 344) {
                $dignity_debility[SE_JUPITER] = 2;
            }
            if ($i == SE_MERCURY And $lng1[$i] >= 344 And $lng1[$i] < 350) {
                $dignity_debility[SE_MERCURY] = 2;
            }
            if ($i == SE_MARS And $lng1[$i] >= 350 And $lng1[$i] < 356) {
                $dignity_debility[SE_MARS] = 2;
            }
            if ($i == SE_SATURN And $lng1[$i] >= 356 And $lng1[$i] < 360) {
                $dignity_debility[SE_SATURN] = 2;
            }
...
//IF THE MOON IS A SIGNIFICATOR, REMIND THE USER TO CHECK THE AMOUNT OF LIGHT THE MOON HAS.
        ...
        for ($i = SE_SUN; $i <= SE_SATURN; $i++) {
            ...
            if ($dignity_debility[$i] == 5) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", exalted ";
            }
            if ($dignity_debility[$i] == 4) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", own sign ";
            }
            if ($dignity_debility[$i] == 3) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", own triplicity ";
            }
            if ($dignity_debility[$i] == 2) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", own term ";
            }
            if ($dignity_debility[$i] == 1) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", own face ";
            }
            if ($dignity_debility[$i] == 0) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", peregrine ";
            }
            if ($detriment[$i] == 1) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", detriment ";
            }
            if ($fall[$i] == 1) {
                $t .= bold_if_significator($t, $i, $rulers, $pl_name) . ", fall ";
            }
                ...
                for ($j = 1; $j <= 11; $j++) {
                    if ($house_pos1[$i] == $j) {
                        if (($hc1[$j + 1] - $lng1[$i] >= 0 And $hc1[$j + 1] - $lng1[$i] <= 5) Or $hc1[$j + 1] - $lng1[$i] <= -355) {
                            if (floor($hc1[$j + 1] / 30) != floor($lng1[$i] / 30)) {
                                break;
                            }   //planet and cusp must be in the same sign
                ...
                for ($j = 1; $j <= 11; $j++) {
                    if ($house_pos1_antiscia[$i] == $j) {
                        if (($hc1[$j + 1] - $antiscia1[$i] >= 0 And $hc1[$j + 1] - $antiscia1[$i] <= 5) Or $hc1[$j + 1] - $antiscia1[$i] <= -355) {
                            if (floor($hc1[$j + 1] / 30) != floor($antiscia1[$i] / 30)) {
                                break;
                            }       //planet and cusp must be in the same sign
        ...
        if (floor($lng1[$rulers[1]] / 30) != floor($hc1[$hse] / 30)) {
            echo "<b>" . $r1_txt . "</b> is NOT in same sign as cusp of present house (this really weakens the influence).<br>";
        }
        ...
        if (floor($lng1[$rulers[2]] / 30) != floor($hc1[$hse] / 30)) {
            echo "<b>" . $r2_txt . "</b> is NOT in same sign as cusp of present house (this really weakens the influence).<br>";
        }
        ...
        if (floor($antiscia1[$rulers[1]] / 30) != floor($hc1[$hse] / 30)) {
            echo "<b>" . $r1_txt . " antiscia </b> is NOT in same sign as cusp of present house (this really weakens the influence).<br>";
        }
        ...
        if (floor($antiscia1[$rulers[2]] / 30) != floor($hc1[$hse] / 30)) {
            echo "<b>" . $r2_txt . " antiscia </b> is NOT in same sign as cusp of present house (this really weakens the influence).<br>";
        }
...
//Reception with the Sun can also be important when judging combustion. A planet combust in its own sign or exaltation is not debilitated at all. That works much like a mutual reception between the planet and the Sun. A planet combust in its own detriment or fall is � if this is possible � debilitated even more seriously than is usual with combustion. It is afflicted by a Sun which, as this negative reception shows, hates it. Bad news indeed!'
        ...
        for ($i = 1; $i <= 2; $i++) {
            ...
            if ($i == 1) {
                if ($lng1[$significator] >= 195 And $lng1[$significator] < 225) {
                    echo "<br><br>" . $r1_txt . " is in the Via Combusta (not good)";
                }
            } else {
                if ($lng1[$significator] >= 195 And $lng1[$significator] < 225) {
                    echo "<br><br>" . $r2_txt . " is in the Via Combusta (not good)";
                }
            }
        }
        ...
        for ($i = 1; $i <= 2; $i++) {
            ...
            for ($j = SE_SUN; $j <= SE_SATURN; $j++) {
                if ($j == $significator) {
                    continue;
                }                  //don't let a significator aspect itself
                ...
                if ($j == SE_SUN) {
                    $orb = 8;
                }           //allow up to an 8-degree orb for any Sun opposition, if the Sun is NOT the significator
        ...
        for ($i = SE_SUN; $i <= SE_SATURN; $i++) {
            if ($i == SE_SUN And $revised_house_pos1[$i] == 9) {
                echo "The Sun is in the 9th house - the house of its joy.<br>";
            }
            if ($i == SE_MOON And $revised_house_pos1[$i] == 3) {
                echo "The Moon is in the 3rd house - the house of its joy.<br>";
            }
            if ($i == SE_MERCURY And $revised_house_pos1[$i] == 1) {
                echo "Mercury is in the 1st house - the house of its joy.<br>";
            }
            if ($i == SE_VENUS And $revised_house_pos1[$i] == 5) {
                echo "Venus is in the 5th house - the house of its joy.<br>";
            }
            if ($i == SE_MARS And $revised_house_pos1[$i] == 6) {
                echo "Mars is in the 6th house - the house of its joy.<br>";
            }
            if ($i == SE_JUPITER And $revised_house_pos1[$i] == 11) {
                echo "Jupiter is in the 11th house - the house of its joy.<br>";
            }
            if ($i == SE_SATURN And $revised_house_pos1[$i] == 12) {
                echo "Saturn is in the 12th house - the house of its joy.<br>";
            }
        }
            ...
            if (floor($lng1[SE_MARS] / 30) == floor($lng1[SE_SATURN] / 30)) {   //Mars and Saturn must be in the same sign
                if ($significator != SE_MARS And $significator != SE_SATURN) {                    //skip Mars and Saturn
                    if ($lng1[SE_SATURN] - $lng1[SE_MARS] >= 0) {
                        if ($lng1[$significator] >= $lng1[SE_MARS] And $lng1[$significator] <= $lng1[SE_SATURN]) {
                            $txt .= $pl_name[$significator] . "   ";
                        }
                    } else {
                        if ($lng1[$significator] >= $lng1[SE_SATURN] And $lng1[$significator] <= $lng1[SE_MARS]) {
                            $txt .= $pl_name[$significator] . "   ";
                        }
                    }
                }
...
Function check_for_Moon($p_num) {
    if ($p_num == 1) {
        return " (check the Moon for the amount of light it has - more is better)";
    }
}
?>