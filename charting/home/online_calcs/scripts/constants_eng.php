...
$asp_color[1] = (isset($blue) ? $blue : NULL);
$asp_color[2] = (isset($red) ? $red : NULL);
$asp_color[3] = (isset($green) ? $green : NULL);
$asp_color[4] = (isset($red) ? $red : NULL);     //$magenta;
$asp_color[5] = (isset($blue) ? $blue : NULL);      //$cyan;
$asp_color[6] = (isset($green) ? $green : NULL);     //$orange;
